...
public class TransactionBroadcast {
    ...
    private final PeerGroup2 peerGroup;
    ...
    public TransactionBroadcast(PeerGroup2 peerGroup2, Transaction tx) {
    ...
    public ListenableFuture<Transaction> broadcast() {
        ...
        ListenableFuture<PeerGroup2> peerAvailabilityFuture = peerGroup.waitForPeers(minConnections);
